...
export const callOutcomeSchema = z.object({ resultId: z.string().uuid(), durationSeconds: z.coerce.number().int().min(0).max(86400).default(0), summary: z.string().max(2000).optional(), scheduledFor: z.string().min(16).max(40).optional() })
